...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img class="d-block img-fluid" src="image/41.jpg" alt="41">
    </div>
    <div class="item">
      <img class="d-block img-fluid" src="image/42.jpg" alt="42">
    </div>
    <div class="item">
      <img class="d-block img-fluid" src="image/43.jpg" alt="43">
    </div>
  </div>
...
<div class="container">    
  <div class="row">
    ...
    <div class="col-sm-6 col-md- col-lg- search12"> 
	 <input type="text" class="form-control search1"  name="user_query" placeholder="search"   />	  
    </div>
    <div class="col-sm-1 col-md- col-lg- btnclr1"> 
	<input type="submit" name="search" class="btn btn-primary btnclr" value="GO">
...
<div class="container template1">    
  ...
  <!-- left block start here -->
	...
	$sql_query = mysqli_query($connection,'SELECT * from rooms ORDER BY Room_Id Asc LIMIT '.$page1.',6'); 	
?>
...
<br>
			...
			<?php echo	'<a href="booknow.php?Room_Id='.$row[0].'" class="btn btn-success btnclr" type="button">Book Now</a>'; ?>
			</div>		
		</div>
		<br/>
	 <?php } ?>
